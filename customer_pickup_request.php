        ...
        <div class="row">
          <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <input type="text" name="sender_available_time_for_pickup" id="" class="form-control form-control-sm" value="<?php echo isset($sender_available_time_for_pickup) ? $sender_available_time_for_pickup : '' ?>" required>
              </div>
              <div class="form-group">
